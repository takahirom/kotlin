...
internal fun shouldCheckClassifierUsage(element: PsiElement): Boolean {
    ...
    if (annotationEntry != null && annotationEntry.calleeExpression!!.constructorReferenceExpression == element) return false
    ...
    if (superExpression != null && superExpression.calleeExpression.constructorReferenceExpression == element) return false
